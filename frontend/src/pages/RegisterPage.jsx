    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
          ...
          {({ errors, touched }) => (
            <Form className="space-y-4">
              <div>
                ...
                <Field name="name" type="text" className="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 focus:ring-2 focus:ring-brand-500" placeholder="Adınız" />
                {errors.name && touched.name && <p className="text-brand-600 text-sm mt-1">{errors.name}</p>}
              </div>
              <div>
              ...
              <div>
                ...
                <Field name="passwordConfirm" type="password" className="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 focus:ring-2 focus:ring-brand-500" />
                {errors.passwordConfirm && touched.passwordConfirm && <p className="text-brand-600 text-sm mt-1">{errors.passwordConfirm}</p>}
              </div>
        ...
        <p className="text-center mt-4 text-sm text-gray-600 dark:text-gray-400">
          Zaten hesabınız var mı? <Link to="/giris" className="text-brand-600 font-semibold">Giriş yapın</Link>
        </p>
      </div>
    </div>
  );
